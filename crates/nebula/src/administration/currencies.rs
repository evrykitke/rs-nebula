...
//! currencies join the in-memory [`crate::money::CurrencyRegistry`] on
//! the next restart; the list endpoints always read the live table.

use crate::audit::Audit;
use crate::auth::Authz;
use crate::auth::permission;
use crate::error::Result;
use crate::money::currency::{self, NewCurrency, Store};
...
/// The currency endpoints' OpenAPI contribution — the source client
